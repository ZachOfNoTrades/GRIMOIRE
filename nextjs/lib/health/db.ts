...
function buildConfig(): sql.config {
  return {
    ...
    database: process.env.SQL_HEALTH_DB!,
...
export async function getHealthConnection(): Promise<sql.ConnectionPool> {
...
export async function closeHealthConnection(_pool: sql.ConnectionPool): Promise<void> {
