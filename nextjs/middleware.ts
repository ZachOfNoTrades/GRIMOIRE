...
export const config = {
  matcher: [
    ...
    // Damnation's guest surface (`/damnation`, `/damnation/<code>`, `/api/damnation/<code>/…`) is
    // public too: guests have no account and authorize with the X-Damnation-Token issued at join.
