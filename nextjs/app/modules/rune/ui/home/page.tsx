        ...
        <div className="mb-8 flex items-center justify-between gap-2">
          ...
          <HelpButton
            ...
            sections={[
              ...
              { heading: "CSV import & export", body: "In a deck's menu, Export cards to CSV downloads every card (front, back, notes, category, draft, source) in the deck's order, as text only — embedded images and videos are left out. Import cards from CSV reads that same file back — into the same deck or another — with the columns already matched." },
