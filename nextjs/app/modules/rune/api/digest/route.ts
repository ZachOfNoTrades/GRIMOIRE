...
// settings — this is what the "Send digest now" button on the settings page hits.
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error('Error in POST /rune/api/digest:', error);
...
export async function DELETE(request: Request) {
  ...
  try {
    ...
    console.error('Error in DELETE /rune/api/digest:', error);
