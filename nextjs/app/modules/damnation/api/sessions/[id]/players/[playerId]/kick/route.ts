...
// POST /modules/damnation/api/sessions/[id]/players/[playerId]/kick — remove a player; their name is released.
export async function POST(
  ...
  return withHost(request, id, "POST /damnation/api/sessions/[id]/players/[playerId]/kick", async (host) => {
    ...
    return hostResult(await removePlayer(host.sessionId, body.op_id, requireUuid(playerId, "Player"), { kind: "host" }));
  });
}
