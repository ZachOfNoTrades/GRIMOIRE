...
function buildConfig(): sql.config {
  return {
    ...
    database: process.env.SQL_QUEST_DB!,
...
export async function getQuestConnection(): Promise<sql.ConnectionPool> {
...
export async function closeQuestConnection(_pool: sql.ConnectionPool): Promise<void> {
