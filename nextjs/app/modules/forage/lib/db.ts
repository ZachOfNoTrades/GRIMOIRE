...
function buildConfig(): sql.config {
  return {
    ...
    database: process.env.SQL_FOOD_DB!,
...
export async function getFoodConnection(): Promise<sql.ConnectionPool> {
...
export async function closeFoodConnection(_pool: sql.ConnectionPool): Promise<void> {
