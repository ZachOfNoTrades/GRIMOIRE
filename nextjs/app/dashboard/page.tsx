      ...
      <div className="page-container">
        ...
        <div className="mb-8 flex items-center justify-between gap-2">
          ...
          <HelpButton
            title="Grimoire"
            sections={[
              { heading: "Modules", body: (<>Each card opens a module:<ul><li><strong>Golem</strong> — workout &amp; program tracking.</li><li><strong>Rune</strong> — flash cards with spaced repetition.</li><li><strong>Quest</strong> — tasks &amp; habits with a coin economy.</li><li><strong>Forage</strong> — food logging &amp; nutrition targets.</li><li><strong>Damnation</strong> — an MTG life tracker: show the board on a screen, players join from their phones with a code.</li></ul></>) },
              { heading: "Badges", body: (<>A card shows a badge when that module needs attention today:<ul><li><strong>Golem</strong> — today&apos;s workout (green once you finish it).</li><li><strong>Rune</strong> — how many cards are due.</li><li><strong>Quest</strong> — today&apos;s bonus task, and anything past its reminder time.</li><li><strong>Forage</strong> — a due weekly check-in, and nothing logged yet by the time set in Forage &rarr; Settings &rarr; Home badge.</li><li><strong>Damnation</strong> — a game you&apos;re hosting is still live.</li></ul></>) },
