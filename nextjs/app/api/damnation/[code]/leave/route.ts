...
// POST /api/damnation/[code]/leave — takes this player out of the game, along with their card.
export async function POST(request: Request) {
  return withGuest(request, "POST /api/damnation/[code]/leave", async (guest) => {
